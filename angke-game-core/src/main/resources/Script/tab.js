...
(function($){
		$.fn.tabs = function(document){
				...
				// 打开网页只运行一次
				wtl.eq(0).css({'background':'#000'}).find('span').css({'color':'rgba(66,133,244,0.95)'});
				...
				wtl.live('click',function(e){
						// 切换样式和打开相应内容66,133,244
						$(this).css({'background':'#000'}).siblings().css({'background':'rgba(66,133,244,0.95)'});	
