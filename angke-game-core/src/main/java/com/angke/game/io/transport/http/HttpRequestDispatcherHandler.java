 ...
 * <p>
 * <ul>
 * <li>{@link HttpRequestDispatcherHandler#channelRead}如果请求是WebSocket升级,
 * 递增引用计数器（保留）并且将它传递给在 {@link ChannelPipeline}中的下个{@link ChannelInboundHandler}
 * <li>{@link HttpRequestDispatcherHandler#send100Continue}处理符合 HTTP 1.1的 "100 Continue" 请求,
...
public class HttpRequestDispatcherHandler extends ChannelInboundHandlerAdapter {
    ...
    static {
        URL location = HttpRequestDispatcherHandler.class.getProtectionDomain().getCodeSource().getLocation();
        try {
    ...
    public HttpRequestDispatcherHandler(String defaultUri, String appContent) {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
    	if (msg instanceof FullHttpRequest) {
    		...
    		System.err.println("转发给专门处理http请求的controller：");
